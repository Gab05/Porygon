...
import { ConfigurableCommandLevels, defaultCommandLevels } from './configurable/command-levels'
import { ConfigurableModerationOptions, defaultModerationOptions } from './configurable/moderation-options'
import { ConfigurableCommands, defaultCommands } from './configurable/standard-commands'

export class Commands {

  private console: ConsoleHelper
  private configCommands: ConfigurableCommands
  private commandLevels: ConfigurableCommandLevels
  private moderationOptions: ConfigurableModerationOptions

  constructor(consoleHelper: ConsoleHelper) {
    this.console = consoleHelper
    this.configCommands = defaultCommands()
    this.commandLevels = defaultCommandLevels()
    this.moderationOptions = defaultModerationOptions()
  }
